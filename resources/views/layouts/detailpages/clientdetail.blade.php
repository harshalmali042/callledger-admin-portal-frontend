...
<body>
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold text-primary"><i class="fa fa-user-circle"></i> Client Details</h3>
            <a href="client-list.html" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
        ...
        <div class="card p-3">
            ...
            <div class="tab-content" id="clientTabContent">
                ...
                <div class="tab-pane fade show active" id="profile" role="tabpanel">
                    ...
                    <div class="container my-4">
                            ...
                            <div class="col-md-3 col-sm-6 mb-3">
                                <div class="card text-center p-3 shadow-sm border-0 bg-light">
                                    <div class="card-body">
                                        ...
                                        <h6 class="fw-bold text-muted">Total Members</h6>
                                        <h4 class="fw-bold text-dark">48</h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div>
                            <a href="/editclient" class="text-decoration-none">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><span class="label">Payment Status:</span> <span
                ...
                <!-- Members Tab -->
                <div class="tab-pane fade table-responsive" id="members" role="tabpanel">
                    <div class="d-flex justify-content-between align-items-center mt-3 mb-2">
                        <h5 class="fw-bold mb-0"><i class="fa fa-user-friends"></i> Team Members</h5>
                        <button class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Member</button>
                    </div>
